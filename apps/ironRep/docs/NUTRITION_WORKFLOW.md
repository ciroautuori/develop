...
| Tool | Funzione | Priorità |
|------|----------|----------|
| `food_search` | Cerca valori nutrizionali | RAG locale → FatSecret fallback |
| `recipe_search` | Cerca ricette fitness | RAG (123 ricette) |
| `user_preferences` | Recupera preferenze utente | User Context RAG |
| `nutrition_guidelines` | Linee guida per obiettivo | RAG knowledge base |

### 3. RAG - ChromaDB Knowledge Base
**Documenti totali:** 9459+

| Sorgente | Quantità | Uso |
|----------|----------|-----|
| USDA FNDDS | 5432 | Valori nutrizionali USA |
| Open Food Facts IT | 3000 | Prodotti italiani con barcode |
| Ricette Fitness | 123 | Piani pasto per sportivi |
| Esercizi | 727 | Cross-reference con nutrizione |
| Medical | 141 | Restrizioni alimentari |
