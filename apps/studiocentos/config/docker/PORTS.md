# 🔌 Port Mapping Reference - StudiocentOS
...
Quando esegui `docker-compose up` con **studiocentos** stack:
...
─────────────────────────────────────────────────────
arch-gcp-backend       8000         ✅ studiocentos-api usa 8002
arch-gcp-postgres      5432         ✅ studiocentos-db usa 5433
arch-gcp-frontend      5173         ✅ studiocentos-web usa 3000
```
...
5432    PostgreSQL           ✅ studiocentos-db usa 5433
6379    Redis                ✅ studiocentos-cache usa 6380
8000    Common API           ✅ studiocentos-api usa 8002
...
DATABASE_URL=postgresql://studiocentos:password@localhost:5432/studiocentos
...
```bash
# Backend usa studiocentos-db interno
DATABASE_URL=postgresql://studiocentos:password@postgres:5432/studiocentos
...
docker exec studiocentos-api ping postgres
docker exec studiocentos-api ping ai_microservice
