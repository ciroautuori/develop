...
from sqlalchemy import (
    ...
    Boolean, Integer, ForeignKey, CheckConstraint
)
...
class Customer(Base):
    ...
    company_vat_id: Mapped[Optional[str]] = mapped_column(String(50))  # P.IVA / VAT
    ...
    tags: Mapped[Optional[str]] = mapped_column(Text)  # "vip,recurring,enterprise"
    ...
    last_contact_type: Mapped[Optional[str]] = mapped_column(String(50))

    # Prossimo follow-up
    next_followup_date: Mapped[Optional[date]] = mapped_column(Date, nullable=True)
    next_followup_notes: Mapped[Optional[str]] = mapped_column(Text)
    ...
    marketing_consent_date: Mapped[Optional[datetime]] = mapped_column(DateTime)
...
class CustomerInteraction(Base):
    ...
    next_action: Mapped[Optional[str]] = mapped_column(Text)  # Cosa fare dopo
