...
class ConnectionManager:
    ...
    async def connect(self, websocket: WebSocket, user_id: Optional[str] = None, is_admin: bool = False):
    ...
    def disconnect(self, websocket: WebSocket, user_id: Optional[str] = None, is_admin: bool = False):
