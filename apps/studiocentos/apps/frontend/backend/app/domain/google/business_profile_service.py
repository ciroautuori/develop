...
class GoogleBusinessProfileService:
    ...
    async def list_locations(self, account_id: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    async def get_location(self, location_name: Optional[str] = None) -> Optional[GMBLocationInfo]:
