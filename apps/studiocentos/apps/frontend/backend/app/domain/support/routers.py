...
async def public_chat_with_ai(
    ...
    try:
        ...
        ai_response = await ai_service.generate_response(
            ...
            context=request.context or "StudioCentOS Landing Page Support",
        ...
        raise HTTPException(
            ...
            detail="AI service temporarily unavailable. Please try again or contact info@studiocentos.it"
        )
