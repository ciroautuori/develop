"""
Finance Notifications Service - Sistema notifiche finanziarie StudioCentOS
...
from .models import CompanyExpense, MonthlyBudget, ROITracking, FinanceAlert
...
class FinanceNotificationsService:
    ...
    @staticmethod
    def create_expense_due_alert(db: Session, expense: CompanyExpense) -> Optional[FinanceAlert]:
    ...
    @staticmethod
    def create_budget_exceeded_alert(db: Session, budget: MonthlyBudget) -> Optional[FinanceAlert]:
    ...
    @staticmethod
    def create_roi_milestone_alert(db: Session, roi: ROITracking) -> Optional[FinanceAlert]:
    ...
    @staticmethod
    def create_cashflow_warning_alert(db: Session, projected_negative_days: int) -> Optional[FinanceAlert]:
    ...
    async def send_alert_email(
        ...
        try:
            ...
            msg['Subject'] = f"[StudioCentOS Finance] {alert.title}"
              ...
              <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                  <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 20px; border-radius: 10px 10px 0 0;">
                    <h1 style="margin: 0; font-size: 24px;">StudioCentOS Finance Alert</h1>
                  </div>
                  ...
                  <div style="background: #f8f9fa; padding: 20px; border-radius: 0 0 10px 10px; border: 1px solid #dee2e6;">
                    ...
                    <div style="text-align: center; margin-top: 30px;">
                      <a href="https://studiocentos.it/admin/finance" 
                  ...
                  <div style="text-align: center; margin-top: 20px; color: #6c757d; font-size: 14px;">
                    <p>Questo è un messaggio automatico del sistema StudioCentOS Finance</p>
                    <p>Per domande contatta: <a href="mailto:ciro@studiocentos.it">ciro@studiocentos.it</a></p>
                  </div>
                </div>
              </body>
            </html>
    ...
    async def send_daily_finance_summary(
        ...
        try:
            ...
            # Crea email
            msg = MIMEMultipart('alternative')
            msg['Subject'] = f"[StudioCentOS] Riepilogo Finance - {today.strftime('%d/%m/%Y')}"
            msg['From'] = smtp_config['from_email']
            msg['To'] = recipient_email
              ...
              <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                  ...
                  <div style="text-align: center; margin-top: 30px; color: #95a5a6; font-size: 14px;">
                    <p>Riepilogo automatico StudioCentOS Finance System</p>
                  </div>
                </div>
              </body>
            </html>
        ...
        try:
            ...
            notification_data = {
                ...
                "notification": {
                    ...
                    "click_action": "https://studiocentos.it/admin/finance"
                },
                "data": {
            ...
            logger.error(f"❌ Failed to send push notification for alert {alert.id}: {str(e)}")
            raise
