...
class InputSanitizer:
    ...
    @classmethod
    def detect_injection_attempt(cls, value: str) -> Optional[str]:
...
class SecureProfileModel(BaseModel):
    ...
    website: Optional[SanitizedUrl] = None
    linkedin_url: Optional[SanitizedUrl] = None
...
def sanitize_request_data(data: Union[Dict, List, str]) -> Union[Dict, List, str]:
