/**
 * STUDIOCENTOS - CENTRALIZED CONFIGURATION
...
export const API_BASE_URL = import.meta.env.VITE_API_URL || 'https://studiocentos.it/api/v1';
...
export const EXTERNAL_URLS = {
  site: 'https://studiocentos.it',
  calendly: {
    base: 'https://calendly.com/studiocentos',
    consultation: 'https://calendly.com/studiocentos/consulenza',
    widget: 'https://assets.calendly.com/assets/external/widget.js',
  },
  social: {
    github: 'https://github.com/studiocentos',
    linkedin: 'https://linkedin.com/company/studiocentos',
  },
  images: {
    og: 'https://studiocentos.it/og-image.jpg',
    twitter: 'https://studiocentos.it/twitter-image.png',
  },
} as const;
