            ...
            >
              ...
              <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    {(['email', 'cta'] as const).map(t => (
                      <button
                        ...
                        className={`flex-1 py-2 rounded-lg ${testType === t ? 'bg-primary text-primary-foreground' : isDark ? 'bg-white/10 text-gray-300' : 'bg-gray-100'
                          }`}
                      >
                ...
                <div>
                  ...
                  {variants.length < 5 && (
                    <button onClick={addVariant} className={`text-sm ${textSecondary} hover:text-primary`}>
                      + Aggiungi variante
                    </button>
                  )}
                </div>
