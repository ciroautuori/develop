...
# Database connection
DATABASE_URL = "postgresql://studiocentos:39a61d2579f38ae46b2c9514e1e5e7ca063772bd3799fb0a48c1ce5bfa8fa17a@localhost:5433/studiocentos"
...
async def test_create_google_meet_event():
    ...
    try:
        ...
        if result:
            ...
            print("   docker logs studiocentos-backend | grep -i google")
            return False
...
async def main():
    """Esegue tutti i test"""
    print("\n" + "="*80)
    print("🔍 STUDIOCENTOS - Google Calendar Integration Test Suite")
    print("="*80)
