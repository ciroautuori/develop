...
# Configurazione
BASE_URL = "https://studiocentos.it/api/v1"
ADMIN_EMAIL = "admin@studiocentos.it"
...
async def run_e2e_test():
    ...
    async with httpx.AsyncClient(timeout=60.0) as client:
        ...
        generated_content = {
            "content": "🚀 Le PMI italiane possono volare con l'AI!\n\nNon serve essere una multinazionale per innovare. StudioCentOS porta l'intelligenza artificiale nel tuo business quotidiano.\n\nScopri come: studiocentos.it #AI #PMI #Innovazione",
            "image_url": "https://studiocentos.it/static/social/post_branded_test.jpg"  # URL simulato
        }
