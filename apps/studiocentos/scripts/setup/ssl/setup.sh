#!/bin/bash
# ============================================================================
# Setup Nginx + SSL PRODUZIONE - studiocentos.it
# Dominio definitivo: studiocentos.it
# ============================================================================

set -e

echo "🚀 SETUP SSL PRODUZIONE - STUDIOCENTOS.IT"
echo "=========================================="
...
# Domini
MAIN_DOMAIN="studiocentos.it"
WWW_DOMAIN="www.studiocentos.it"
...
sudo tee /etc/nginx/sites-available/studiocentos.conf > /dev/null <<EOF
...
# Abilita sito
sudo ln -sf /etc/nginx/sites-available/studiocentos.conf /etc/nginx/sites-enabled/
...
if [[ $REPLY =~ ^[Yy]$ ]]; then
    ...
    if [ $? -eq 0 ]; then
        ...
        sudo cp /home/autcir_gmail_com/studiocentos_ws/config/services/nginx/studiocentos-production.conf \
                /etc/nginx/sites-available/studiocentos.conf
...
echo "  - /etc/nginx/sites-available/studiocentos.conf"
