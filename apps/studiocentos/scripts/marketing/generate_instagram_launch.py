...
Genera i primi 7 post professionali per il lancio del profilo Instagram @studiocentos.
...
LAUNCH_CONTENT = [
    {
        "day": 1,
        "topic": """POST DI LANCIO - Presentazione StudioCentOS
