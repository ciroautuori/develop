#!/bin/bash
# ============================================================================
# markettina - INSTALLAZIONE COMPLETA AUTOMATICA
# ============================================================================

set -e

echo "🚀 markettina - INSTALLAZIONE COMPLETA"
echo "=========================================="
echo ""
...
sudo -u postgres psql -c "DROP DATABASE IF EXISTS markettina;" 2>/dev/null || true
sudo -u postgres psql -c "DROP USER IF EXISTS markettina;" 2>/dev/null || true
sudo -u postgres psql << EOF
CREATE USER markettina WITH PASSWORD 'markettina2025';
CREATE DATABASE markettina OWNER markettina;
GRANT ALL PRIVILEGES ON DATABASE markettina TO markettina;
ALTER USER markettina CREATEDB;
EOF
...
cd /home/ciroautuori/markettina/config/docker
