...
API_BASE = "https://markettina.it/api/v1/admin/portfolio"

# Login admin per ottenere token
def get_admin_token():
    """Login e ottieni token admin"""
    login_url = "https://markettina.it/api/v1/admin/auth/login"
...
def seed_services(token):
    ...
    services_data = [
        {
            "title": "markettina Framework",
            "slug": "markettina-framework",
...
def main():
    """Main function"""
    print("\n" + "="*60)
    print("  SEED PORTFOLIO VIA API - markettina")
    print("="*60 + "\n")
    ...
    try:
        ...
        print("🌐 Testa la landing: https://markettina.it")
        print("🔧 Testa il back-office: https://markettina.it/admin/portfolio\n")
