...
**Production Services**:
- HTTPS: https://markettina.it
- API: https://markettina.it/api/v1
- AI: https://markettina.it/ai
...
docker build -f config/docker/dockerfiles/ai_microservice.Dockerfile \
  -t markettina/ai-microservice:latest .
```
