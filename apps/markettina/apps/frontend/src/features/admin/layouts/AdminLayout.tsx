        ...
        <div className="flex h-full flex-col">
          ...
          <div className="flex h-16 items-center justify-between border-b border-border px-6">
            <div className="flex items-center gap-3 h-8">
              ...
              />
              <span className="text-lg font-bold tracking-tight text-foreground">MARKETTINA</span>
            </div>
            <Button
              variant="ghost"
              size="icon"
          ...
          <div className="border-t border-border p-4 bg-muted/30">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground truncate">admin@markettina.com</p>
              </div>
        ...
        <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-border bg-background/80 backdrop-blur-md px-4 sm:px-6">
          ...
          <div className="flex flex-1 items-center gap-2">
            <div className="relative w-full max-w-md hidden sm:block">
              ...
              <input
                type="search"
                placeholder="Cerca in Markettina..."
