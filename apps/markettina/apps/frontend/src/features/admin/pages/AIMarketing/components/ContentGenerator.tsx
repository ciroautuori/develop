...
const PLATFORMS: Platform[] = [
  { id: 'linkedin', label: 'LinkedIn', icon: Linkedin, maxChars: PLATFORM_FORMAT_RULES.linkedin.maxChars, color: '#0A66C2' },
  { id: 'facebook', label: 'Facebook', icon: Facebook, maxChars: PLATFORM_FORMAT_RULES.facebook.maxChars, color: '#1877F2' },
  { id: 'instagram', label: 'Instagram', icon: Instagram, maxChars: PLATFORM_FORMAT_RULES.instagram.maxChars, color: '#E4405F' },
  { id: 'twitter', label: 'X (Twitter)', icon: Twitter, maxChars: PLATFORM_FORMAT_RULES.twitter.maxChars, color: '#000000' },
];
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {currentTemplates.slice(0, 8).map((template) => (
              <button
                key={template.value}
                onClick={() => setTopic(template.value)}
                className={cn(
