...
async def generate_ai_content():
    ...
    try:
        ...
        prompt = """Crea un post social professionale per MARKETTINA, software house italiana.
...
Genera SOLO il testo del post, senza indicazioni extra."""
        ...
        return "🚀 Il futuro è già qui con l'AI! Scopri come MARKETTINA può trasformare il tuo business digitale. #AI #Innovation #TechItalia"
