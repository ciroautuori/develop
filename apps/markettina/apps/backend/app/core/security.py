...
def encrypt_pii(value: str) -> str:
    ...
    try:
        ...
        raise ValueError(f"Failed to encrypt PII data: {e!s}")
...
def decrypt_pii(encrypted_value: str) -> str:
    ...
    try:
        ...
        raise ValueError(f"Failed to decrypt PII data: {e!s}")
...
def rotate_encryption_key(old_key: str, new_key: str, encrypted_value: str) -> str:
    ...
    try:
        ...
        raise ValueError(f"Failed to rotate encryption key: {e!s}")


# =============================================================================
# API KEY VERIFICATION (for AI endpoints)
# =============================================================================
...
async def verify_api_key(
    ...
    This is a simplified verification for internal AI service calls.
    For production, implement proper API key management with database storage.
    ...
    if not expected_key or expected_key == "dev-api-key-change-in-production":
        return True
...
def get_api_key_header():
    ...
    async def _verify(x_api_key: str | None = Header(None, alias="X-API-Key")):
