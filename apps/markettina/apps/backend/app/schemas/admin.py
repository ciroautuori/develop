...
class AdminLoginRequest(BaseModel):
    ...
    totp_token: str | None = Field(None, min_length=6, max_length=6, description="Token 2FA se abilitato")
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "qr_code_url": "otpauth://totp/markettina:admin?secret=JBSWY3DPEHPK3PXP&issuer=markettina",
...
class Admin2FADisableRequest(BaseModel):
    ...
    totp_token: str | None = Field(None, min_length=6, max_length=6, description="Token 2FA o backup code")
