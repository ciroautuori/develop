...
class MarketingService:
    ...
    def search_leads_salerno_campania(
        ...
        Integrare Google Maps API, LinkedIn, CCIAA.
        """
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto;">
    <div style="background: #D4AF37; padding: 20px; text-align: center;"><h1>{brand.company_name if brand else 'MARKETTINA'}</h1></div>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Sono Ciro di MARKETTINA, software house specializzata in:</p>
            <ul>
            ...
            <a href="https://markettina.it#prenota" class="cta">
        ...
        <div class="footer">
            <p><strong>MARKETTINA</strong><br>
            Salerno, Campania<br>
            info@markettina.it<br>
            https://markettina.it</p>
        </div>
    </div>
</body>
</html>
"""
        ...
        text_content = f"""
markettina - Software House Salerno

Ciao da {request.target_region}!

Sono Ciro di MARKETTINA, software house specializzata in:
