...
class LeadEnrichmentService:
    ...
    async def _geocode_location(self, location: str, api_key: str) -> dict | None:
    ...
    async def get_company_logo(self, domain: str) -> str | None:
        """
        Ottieni logo aziendale da Clearbit (free tier).

        Args:
            domain: Dominio aziendale (es. markettina.it)
