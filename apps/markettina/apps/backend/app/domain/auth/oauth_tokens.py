...
class OAuthTokenService:
    ...
    @staticmethod
    def get_oauth_token(db: Session, user_id: int, provider: str) -> OAuthToken | None:
    ...
    def is_token_expired(token: OAuthToken) -> bool:
        ...
        return datetime.now(UTC) >= (token.expires_at - buffer)

    @staticmethod
    def refresh_google_token(db: Session, user_id: int) -> OAuthToken | None:
        """
    ...
    @staticmethod
    def refresh_linkedin_token(db: Session, user_id: int) -> OAuthToken | None:
        """
    ...
    @staticmethod
    def get_valid_token(db: Session, user_id: int, provider: str) -> str | None:
        """
