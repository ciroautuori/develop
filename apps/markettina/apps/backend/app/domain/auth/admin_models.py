...
class AdminUser(Base):
    ...
    backup_codes: Mapped[str | None] = mapped_column(Text)  # JSON array encrypted
    ...
    setup_token: Mapped[str | None] = mapped_column(String(255))
    ...
    # Role for RBAC (admin, editor, viewer)
