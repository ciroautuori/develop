...
from app.core.api.dependencies.auth_deps import (
    get_current_admin_user,
    require_permission,
)
from app.core.constants.auth_constants import Permission
from app.infrastructure.database.session import get_db

from .admin_models import AdminUser
from .settings_models import AdminPasswordHistory, AdminSettings
...
def get_settings(
    ...
    """Get admin settings. Requires SETTINGS_READ permission."""
...
def toggle_integration(
    ...
    db: Session = Depends(get_db),
    admin: AdminUser = Depends(require_permission(Permission.INTEGRATIONS_WRITE))
):
...
def get_integrations_status(
    db: Session = Depends(get_db),
    admin: AdminUser = Depends(require_permission(Permission.INTEGRATIONS_READ))
):
