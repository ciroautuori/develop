...
class GoogleAnalyticsService:
    ...
    def __init__(self, access_token: str, property_id: str | None = None):
        """
    ...
    @classmethod
    def from_admin_token(cls, db: Session, admin_id: int, property_id: str | None = None) -> Optional["GoogleAnalyticsService"]:
        """
    ...
    async def list_properties(self, account_id: str | None = None) -> list[dict[str, Any]]:
