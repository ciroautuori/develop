"""
Finance Reports Service - Sistema report e export MARKETTINA
"""
...
from .models import CompanyExpense, MonthlyBudget
...
class FinanceReportsService:
    ...
    @staticmethod
    def export_expenses_csv(db: Session, year: int, category: str | None = None) -> bytes:
        """Export spese in CSV"""
