"""
Finance Models - Gestione finanziaria MARKETTINA
"""
...
class MonthlyBudget(Base):
    ...
    Pianificazione e controllo budget MARKETTINA.
    """
...
class ROITracking(Base):
    ...
    Monitora il ritorno degli investimenti MARKETTINA.
    """
