...
class CustomerService:
    ...
    def create_customer(
        ...
        # Decrypt and check emails (Note: This is slow for large datasets)
    ...
    def count_customers(self, filters: CustomerFilters | None = None) -> int:
        """
    ...
    def update_customer(
        ...
        if update_data.get("marketing_consent"):
    ...
    def restore_customer(self, customer_id: int) -> Customer | None:
        """
    ...
    def recalculate_customer_ltv(self, customer_id: int) -> Customer | None:
        """
