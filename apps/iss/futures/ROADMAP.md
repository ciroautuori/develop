# 🗺️ ISS Project Roadmap

## 📂 Directory Structure
- `current/`: Current active tasks (managed via task.md)
- `futures/`: Planned features and ideas
  - `planned/`: Features agreed upon but not started
  - `in_progress/`: Long-term features being worked on
  - `complete/`: Archived major milestones
